...
# طبقِ درخواستِ صریح («برنامه در آینده بزرگ‌تر می‌شود، ریبونِ میان‌بر باید
# برایِ هر ماژول قابلِ‌تنظیم باشد»): ریبونِ میان‌برهایِ پرکاربردِ بالایِ
# ساید‌بار (shell_window.py) از همین‌جا خوانده می‌شود — تکِ منبعِ حقیقتِ
# ناوبری، نه یک فهرستِ جداگانه‌یِ hardcode‌شده در خودِ shell. هر ماژولِ
# تازه‌ای که در آینده اضافه می‌شود، میان‌برهایِ خودش را همین‌جا اضافه
# می‌کند (کدِ آیتم از NAV_ITEMS، گلیفِ آیکون).
QUICK_ACCESS_ITEMS: list[tuple[str, str]] = [
    ("GL_JE", "📝"),
    ("GL_COA", "🗂️"),
    ("GL_JE_LIST", "📚"),
    ("GL_TAFSILI", "🤝"),
