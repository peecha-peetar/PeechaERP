...
NAV_ITEMS = [
    ...
    },
    {
        ...
        "children": [
            ...
            # شلوغ نشه»): پخشِ گرم + زیرساختِ میدانیِ مشترک (ویزیت/بارگیریِ
            # خودرو/پروموشن/داشبورد/بازاریابی) زیرِ یک آیتمِ تب‌دار --
            # هم‌الگو با فروشِ اینترنتی بالا. ماژولِ سومِ کاربر (اپِ سفارشِ
            # موبایل) نیازمندِ یک تصمیمِ معماریِ جداگانه (API/Offline-Sync)
            # است و در همین دور اضافه نشده.
            {"code": "SALES_DISTRIBUTION", "label": "پخشِ گرم و ابزارهایِ میدانی", "screen": "commercial_distribution_hub"},
