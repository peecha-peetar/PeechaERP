...
class CommercialAftersalesScreen(QWidget):
    ...
    def _build_warranty_tab(self) -> QWidget:
        ...
        add_warranty_button.setFixedWidth(40)
    ...
    def _build_ticket_tab(self) -> QWidget:
        ...
        add_ticket_button.setFixedWidth(40)
        ...
        apply_status_button.setFixedWidth(34)
        ...
        link_invoice_button.setFixedWidth(34)
        ...
        add_part_button.setFixedWidth(34)
    ...
    def _build_rma_tab(self) -> QWidget:
        ...
        add_rma_button.setFixedWidth(40)
