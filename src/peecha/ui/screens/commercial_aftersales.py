...
class CommercialAftersalesScreen(QWidget):
    ...
    def _build_warranty_tab(self) -> QWidget:
        ...
        add_warranty_button = QPushButton("+ صدورِ گارانتی")
        add_warranty_button.setObjectName("primaryButton")
    ...
    def _build_ticket_tab(self) -> QWidget:
        ...
        apply_status_button = QPushButton("اعمال")
        ...
        link_invoice_button = QPushButton("پیوند")
        ...
        add_part_button = QPushButton("+ ثبتِ مصرف")
    ...
    def _build_rma_tab(self) -> QWidget:
        ...
        approve_button = QPushButton("تاییدِ RMA")
        ...
        reject_button = QPushButton("ردِ RMA")
