...
قدیمیِ کاربر («منوها شلوغ نشه») یک تبِ جدید بود، نه یک آیتمِ جدیدِ
منو؛ از R212 (تفکیکِ پخشِ گرم از زیرساختِ میدانیِ مشترک) این تب داخلِ
sales_planning_hub.py است، نه commercial_distribution_hub.py -- چون
مخصوصِ پخشِ گرم نیست، هر دو کانال را پوشش می‌دهد.
