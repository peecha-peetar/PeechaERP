...
class _PoliciesTab(FormScreenBase):
    def __init__(self) -> None:
        ...
        edit_button = QPushButton("ویرایشِ قانونِ انتخاب‌شده")
...
class _TaxTab(FieldHelpMixin, FormScreenBase):
    def __init__(self) -> None:
        ...
        add_row_button = QPushButton("+ افزودنِ پلکان")
        ...
        save_brackets_button = QPushButton("ذخیرهٔ پلکان‌ها")
        save_brackets_button.setObjectName("primaryButton")
        save_brackets_button.clicked.connect(self._save_brackets)
        self.footer_layout.addWidget(save_brackets_button)

        save_exemption_button = QPushButton("ذخیرهٔ سقفِ معافیت")
        save_exemption_button.setObjectName("primaryButton")
