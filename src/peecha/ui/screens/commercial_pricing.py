...
class CommercialPricingScreen(QWidget):
    ...
    def _build_price_lists_tab(self) -> QWidget:
        ...
        add_pl_button = QPushButton("+ فهرستِ قیمتِ تازه")
        add_pl_button.setObjectName("primaryButton")
        ...
        add_item_button = QPushButton("+ ثبتِ قیمت")
    ...
    def _build_discount_rules_tab(self) -> QWidget:
        ...
        add_rule_button = QPushButton("+ قاعدهٔ تازه")
        ...
        add_tier_button = QPushButton("+ افزودنِ پله")
