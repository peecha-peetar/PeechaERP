...
class CommercialPosSaleScreen(QWidget):
    def __init__(self) -> None:
        ...
        new_sale_button = QPushButton("فروشِ تازه")
        new_sale_button.setObjectName("flatButton")
        ...
        add_line_button = QPushButton("+ افزودنِ کالا")
        ...
        finalize_button = QPushButton("تکمیلِ فروش (تاییدِ نهایی)")
        finalize_button.setObjectName("primaryButton")
        ...
        add_payment_button = QPushButton("+ افزودنِ پرداخت")
