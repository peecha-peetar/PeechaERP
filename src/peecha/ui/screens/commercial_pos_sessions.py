...
class CommercialPosSessionsScreen(QWidget):
    def __init__(self) -> None:
        ...
        add_terminal_button = QPushButton("+ ترمینالِ تازه")
        add_terminal_button.setObjectName("primaryButton")
        ...
        save_settings_button = QPushButton("ذخیره")
        ...
        self.open_session_button = QPushButton("بازکردنِ جلسه")
        self.open_session_button.setObjectName("primaryButton")
        ...
        self.close_session_button = QPushButton("بستنِ جلسه")
        ...
        self.override_button = QPushButton("آزادسازیِ مغایرت")
