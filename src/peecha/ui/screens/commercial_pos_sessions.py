...
class CommercialPosSessionsScreen(QWidget):
    def __init__(self) -> None:
        ...
        add_terminal_button.setFixedWidth(40)
        ...
        save_settings_button.setFixedWidth(34)
        ...
        self.open_session_button.setFixedWidth(40)
        ...
        self.close_session_button.setFixedWidth(34)
        ...
        self.override_button.setFixedWidth(34)
