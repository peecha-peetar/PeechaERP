    ...
    def __init__(self) -> None:
        ...
        self.set_field_help([
            ...
            (
                ...
                "درصدِ مالیاتِ پیش‌فرضِ همه‌یِ کالاهایِ این شرکت. طبقِ سیاستِ اولویتی، اگر این‌جا مقدار داشته باشد، "
                "بر مالیاتِ انبار و مالیاتِ خودِ کالا اولویت دارد و برایِ همه یکسان اعمال می‌شود. خالی بگذارید تا "
                "نوبت به تنظیماتِ انبار/کالا برسد.",
            ),
            (
