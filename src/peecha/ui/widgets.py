...
# طبق مدرن‌سازیِ ظاهر (نسخه‌ی دوم): مقادیرِ قبلی (۰.۰۳۵/۰.۰۵/۰.۰۷) آن‌قدر
# کم‌رنگ بودند که در تست کاربر اصلاً حس نشدند؛ این مقادیر تقریباً دوبرابر
# پررنگ‌ترند تا عمقِ کارت‌ها واقعاً به چشم بیاید.
_SHADOW_LAYERS = [
    (dp(16), dp(20), 0.07),
    (dp(8), dp(11), 0.09),
    (dp(3), dp(4), 0.11),
